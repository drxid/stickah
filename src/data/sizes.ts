...
export const SIZE_PRESETS: SizePreset[] = [
  {
    ...
    width: 40,
    height: 40,
    description: 'Крышка маленькой банки',
  },
  {
    id: 'round-50',
    label: 'Круг 50 мм',
    ...
    width: 50,
    height: 50,
    description: 'Крышка средней банки',
  },
  {
    id: 'round-60',
    label: 'Круг 60 мм',
    ...
    width: 60,
    height: 60,
    description: 'Крышка большой банки',
  },
  {
    id: 'rect-50x30',
    label: 'Прямоуг. 50×30 мм',
    shape: 'rect',
    width: 50,
    height: 30,
    description: 'Боковая наклейка',
  },
  {
    id: 'rect-70x40',
    label: 'Прямоуг. 70×40 мм',
    shape: 'rect',
    width: 70,
    height: 40,
    description: 'Боковая, длинные названия',
  },
  {
    id: 'rect-120x45',
    label: 'Прямоуг. 120×45 мм',
    shape: 'rect',
    width: 120,
    height: 45,
    description: 'Широкая боковая, дизайн Grove',
  },
];
